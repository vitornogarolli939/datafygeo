...
Israel Henrique, CTO da Datafy, resume a regra: *"não importa se isso aqui é proibido ou legalizado no teu país. Se a meta proíbe, tá proibido."*

::numeros: 1 política|a da Meta, acima da lei local ;; 1 cláusula|aberta, sobre o que a Meta determinar ;; 0|fornecedores que mudam essa regra ;; seção 4|da política comercial, onde está a lista
...
## Casos de clientes da Datafy

Dois casos da base de clientes da Datafy mostram a lista na prática.

**A empresa de eventos.** Um cliente contratou a API para uma empresa de eventos que vendia festas de 15 anos e casamentos. Os pacotes sempre incluíam cerveja e vinho, e o número dele era bloqueado por causa disso.

**O vendedor de odds.** Um cliente contratou a API achando que deixaria de ser bloqueado, foi bloqueado e reclamou. Ele mandava cotações de apostas para uma lista. Aposta é proibida explicitamente pela política da Meta, e não havia o que contestar.

::video: cZ_nyIUv5ic | A lista de nichos proibidos, com os casos da empresa de eventos e do vendedor de odds.

Outras categorias da lista, com exemplos:

**Produtos médicos e de saúde.** Quem vende suplemento, como proteína para academia, pode ser bloqueado, dependendo do caso.

**Animais vivos.** Mesmo sem nada clandestino e sem maus-tratos, não pode.

**Moeda virtual.** Bitcoin, day trade e opção binária entram aqui.

**Cobrança de dívida.** É a mais contraintuitiva. Banco, financeira ou qualquer empresa que envia mensagem cobrando conta ou dívida está na lista.

## A cláusula aberta

O trecho que permite à Meta agir contra o que ela concluir ser fraudulento ou enganoso é amplo e subjetivo. Uma oferta de ação que promete render 30% ao mês é o tipo de coisa que cai nele.

Quem decide se a oferta é enganosa é a Meta, e não a empresa. Se a Meta entender que é enganosa, a empresa pode ser bloqueada, mesmo que considere a oferta legítima.

::video: cZ_nyIUv5ic | A leitura da cláusula sobre o que a Meta conclui ser fraudulento ou enganoso, e por que vale a regra da Meta e não a lei do país.
...
Pode contar, dependendo do caso. A política lista produtos médicos e de saúde.

### Minha empresa não vende bebida, mas o pacote inclui. Tem risco?

Tem. Foi o caso de um cliente da Datafy, empresa de eventos, bloqueado porque os pacotes tinham cerveja e vinho.
...
Leia a seção 4 da política antes de montar a operação no WhatsApp. Se o seu produto está na lista, o WhatsApp não é canal para vendê-lo. Se está na zona da cláusula aberta, a pergunta que ajuda é: a Meta pode entender a sua oferta como enganosa?
